...
Hi!! So GitHub has a 1MB max upload, so if you want to look at bigger images, they are in a separate file. Please reach out if there's anything else you find interesting or any comments! 
